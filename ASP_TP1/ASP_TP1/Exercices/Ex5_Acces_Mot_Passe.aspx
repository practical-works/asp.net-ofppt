<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ex5_Acces_Mot_Passe.aspx.cs" Inherits="Exercices_Ex4_Acces_Mot_Passe" %>
...
<body>
    ...
    <div class="style2">
        ...
        <br class="style1" />
        <asp:TextBox ID="TextBox_password" runat="server" CssClass="style1"></asp:TextBox>
        <br class="style1" />
        <br class="style1" />
